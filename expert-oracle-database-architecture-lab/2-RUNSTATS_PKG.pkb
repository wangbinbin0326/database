...
begin
    ...
    for x in(select rpad(a.name, 30) || to_char(b.value-a.value, '999,999,999') || to_char(c.value-b.value, '999,999,999') 
             ...
             where a.name = b.name
               ...
               and b.runid = 'after 1'
               and c.runid = 'after 2'  
               and abs((c.value-b.value)-(b.value-a.value)) > p_difference_threshold ) loop
    ...
    for x in
        (select to_char(run1, '999,999,999') || to_char(run2, '999,999,999') || to_char(diff, '999,999,999') 
